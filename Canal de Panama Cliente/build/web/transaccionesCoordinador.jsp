<%-- 
    Document   : transaccionesCoordinador
...
<html lang="es">
    ...
    <body>
        <div class="ui blue top fixed inverted menu">
            ...
            <a href="#" class="item">Transacciones</a>
            <a href="subastaCliente.jsp" class="item">Subasta</a>

            <form method="POST" action="transaccionesCoordinador.jsp">
    ...
    <div class="ui container">
        ...
        <div class="ui vertically divided grid">
            <div class="column row">
                <div class="column">
                    <form method="POST" class="ui form" id="formulario" action="transaccionesCoordinador.jsp">
                        <h4 class="ui dividing header">Consulta de movimientos y transacciones</h4>
                                ...
                                <%
                                    if (request.getParameter("cargarPagos") != null) {
                                        try {
                                            ...
                                            java.util.List<servidor.PagoVO> pagos = port.leerPagosCoord();
